...
export class InterventionDetails implements  OnInit
{
    ...
    @ContentChildren(Section) sections : QueryList<Section>;
    ...
    private get listTypeMainCour() : string[] { return [''].concat(this.interService.listeTypeMaincour.filter( v => v != undefined)); };
    ...
    constructor( private r: Renderer, private el: ElementRef, private interService: InterventionService )
    {
